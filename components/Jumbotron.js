    ...
    <section>
      <div className="jumbotron__container row mr-0">
        <div className="jumbotron__elements-container col-md-8 col-lg-6">
          <h3 className="d-block d-sm-block d-md-none jumbotron__spot-title">HOLA! SOMOS INVUELTO!</h3>
          ...
          <h3 className="d-none d-sm-none d-md-block jumbotron__spot-title">HOLA! SOMOS INVUELTO!</h3>
        </div>
